    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      <div className="space-y-8">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>We may collect information like your name, email address, and other details you provide when you register, use our services, or contact us.</p>
            
            <h2 className="font-headline text-2xl text-foreground font-bold pt-4">2. How We Use Your Information</h2>
            ...
            <h2 className="font-headline text-2xl text-foreground font-bold pt-4">3. Security</h2>
